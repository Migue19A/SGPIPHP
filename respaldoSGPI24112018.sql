...
-- Started on 2018-11-24 03:27:36
...
--
-- TOC entry 234 (class 1259 OID 33697)
...
--
-- TOC entry 233 (class 1259 OID 33695)
-- Name: cambioAlumnos2_id_solicitud_seq; Type: SEQUENCE; Schema: public; Owner: postgres
--

CREATE SEQUENCE public."cambioAlumnos2_id_solicitud_seq"
    START WITH 1
    INCREMENT BY 1
    NO MINVALUE
    NO MAXVALUE
...
ALTER TABLE public."cambioAlumnos2_id_solicitud_seq" OWNER TO postgres;

--
-- TOC entry 2485 (class 0 OID 0)
-- Dependencies: 233
-- Name: cambioAlumnos2_id_solicitud_seq; Type: SEQUENCE OWNED BY; Schema: public; Owner: postgres
--

ALTER SEQUENCE public."cambioAlumnos2_id_solicitud_seq" OWNED BY public."cambioAlumnos".id_solicitud;
...
--
-- TOC entry 2203 (class 2604 OID 33700)
-- Name: cambioAlumnos id_solicitud; Type: DEFAULT; Schema: public; Owner: postgres
--

ALTER TABLE ONLY public."cambioAlumnos" ALTER COLUMN id_solicitud SET DEFAULT nextval('public."cambioAlumnos2_id_solicitud_seq"'::regclass);
...
--
-- TOC entry 2476 (class 0 OID 33697)
-- Dependencies: 234
-- Data for Name: cambioAlumnos; Type: TABLE DATA; Schema: public; Owner: postgres
--

INSERT INTO public."cambioAlumnos" (id_solicitud, id_alum, folio_proyecto, id_tipo_cambio, motivo, nc_reemplazo, fecha_peticion, semestre, servic, resid, tesis, actividades_actuales) VALUES (1, '127O0949', 'PRE4', 6, 'Porque ya no trabaja', NULL, '2018-11-24', NULL, B'0', B'0', B'0', NULL);


--
-- TOC entry 2494 (class 0 OID 0)
-- Dependencies: 233
-- Name: cambioAlumnos2_id_solicitud_seq; Type: SEQUENCE SET; Schema: public; Owner: postgres
--

SELECT pg_catalog.setval('public."cambioAlumnos2_id_solicitud_seq"', 1, true);
...
INSERT INTO public."cambioColaboradores" (id_solicitud, id_doc, folio_proyecto, id_tipo_cambio, motivo, np_reemplazo, fecha_peticion, actividades_actuales) VALUES (1, 32, 'PRE4', 2, 'El docente anterior tuve que salir de viaje a Europa', 5, '2018-11-24', 'CHECAR EL CÓDIGO');
INSERT INTO public."cambioColaboradores" (id_solicitud, id_doc, folio_proyecto, id_tipo_cambio, motivo, np_reemplazo, fecha_peticion, actividades_actuales) VALUES (2, 1, 'PRE4', 3, 'Porque ya no trabaja', NULL, '2018-11-24', NULL);
...
SELECT pg_catalog.setval('public."cambioColaboradores2_id_solicitud_seq"', 2, true);
...
--
-- TOC entry 2305 (class 2606 OID 33709)
-- Name: cambioAlumnos cambioAlumnos2_pkey; Type: CONSTRAINT; Schema: public; Owner: postgres
--

ALTER TABLE ONLY public."cambioAlumnos"
    ADD CONSTRAINT "cambioAlumnos2_pkey" PRIMARY KEY (id_solicitud);
...
-- Completed on 2018-11-24 03:27:37
