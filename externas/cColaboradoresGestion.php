...
//$proyectosActivos = $miConn->obtenerProyectosDocente($_SESSION['NoPersonal']);
    $solicitudesPendientesC = $conn->obtenerSolicCambioColaboradores();
    $solicitudesPendientesA = $conn->obtenerSolicCambioAlumnos();
    $obs_inv = '';  
    $estado_solic = 0;
    $estado_AC = 0;
    $estado_CC = 0;   
                    ...
                    <table class="table table-condensed" style="float: center;">
                        ...
                        <tbody>
                            ...
                            <tr>
                                ...
                                ?>
                                        <?php if($estado_solic != 13){ 
                                            $observacionesInv = $conn -> obtenerObservacionesInv($r['folio_p'], 11);
                                            if($res = pg_fetch_array($observacionesInv)){
                                                $obs_inv = $res[0];
                                            }
                                        ?>                                        
                                ...
                                ?>
                                        <?php if($estado_solic !=13){ 
                                            $observacionesInv = $conn -> obtenerObservacionesInv($r['folio_p'], 12);
                                            if($res = pg_fetch_array($observacionesInv)){
                                                $obs_inv = $res[0];
                                            }
                                        ?>                                        
                                ...
                                ?>
                                        <?php if($estado_solic != 13){ 
                                            $observacionesInv = $conn -> obtenerObservacionesInv($r['folio_p'], 13);
                                            if($res = pg_fetch_array($observacionesInv)){
                                                $obs_inv = $res[0];
                                            }
                                        ?>                                        
                    ...
                    <table class="table table-condensed" style="float: center;">
                        ...
                        <tbody>
                            ...
                            <tr>
                                ...
                                ?>
                                        <?php if($estado_solic != 13){ 
                                            $observacionesInv = $conn -> obtenerObservacionesInv($r['folio_p'], 14);
                                            if($res = pg_fetch_array($observacionesInv)){
                                                $obs_inv = $res[0];
                                            }
                                        ?>                                   
                                ...
                                ?>
                                        <?php if($estado_solic != 13){ 
                                            $observacionesInv = $conn -> obtenerObservacionesInv($r['folio_p'], 15);
                                            if($res = pg_fetch_array($observacionesInv)){
                                                $obs_inv = $res[0];
                                            }
                                        ?>                                   
            ...
            <div class="modal-content">
                ...
                <div class="modal-body">
                    <div class="form-group">
                        ...
                        <label>Observaciones de la Subdirección de Investigación y Posgrado</label>
                ...
                <?php if($estado_BC != 12){ ?>         
                    <div class="modal-footer">
                        <button class="btn btn-success" disabled onclick="tipo(1)" type="submit">Aceptar</button>
                        <button class="btn btn-danger" disabled onclick="tipo(2)" type="submit">Rechazar</button>
                        <button class="btn btn-primary" disabled onclick="tipo(3)" type="submit">Enviar a investigación</button>
                        <button class="btn btn-default"  data-dismiss="modal" type="button">Cerrar</button>
                    </div>
                <?php }else{ ?>

                    <div class="modal-footer">
                        <button class="btn btn-success" onclick="tipo(1)" type="submit">Aceptar</button>
                        <button class="btn btn-danger" onclick="tipo(2)" type="submit">Rechazar</button>
                        <button class="btn btn-primary" onclick="tipo(3)" type="submit">Enviar a investigación</button>
                        <button class="btn btn-default"  data-dismiss="modal" type="button">Cerrar</button>
                    </div>
                <?php } ?>
            </form>
        ...
        <div class="modal-dialog modal-lg">
            <div class="modal-content">
                ...
                <div class="modal-body">
                        ...
                        <div class="form-group">
                            <label>Observaciones de la Subdirección de Investigación y Posgrados</label>
