                    ...
                    <table class="table table-condensed">
                        ...
                        <?php 
                            ...
                            while($r = pg_fetch_array($res)){
                                ...
                                if($estado != 'EN PRORROGA INV.' || $estado == 'EN PRORROGA' || $estado == 'EN PRORROGA COM.'){
                                ...
                                if($estado == 'EN PRORROGA COM.'){
                                    echo "<td><button class='btn btn-info' data-target='#myModal' data-toggle='modal' onclick='ajaxProrrogaConsultas(this.id)' id='".$r[2]."' name='".$r[2]."' type='submit' method='POST' disabled value='".$r[2]."'/>Enviado</button></td>";    
                    ...
                    <div class="">
                        <div class="modal-content">
                            <form id="observacionesI_prorroga" name="observacionesI_prorroga" method="POST" onsubmit="SolicitudEnviada(this.id)">
                                <input type="hidden" name="accion" value="observacionesI_prorroga">
                                                    ...
                                                    <ul class="nav bs-docs-sidenav">
                                                        <div class="container" id="navObserv">
                                                            ...
                                                            <div class="panel panel-primary panel-default" id="navObserv">
                                                                <div class="panel-heading">
                                                                    <h5 class="panel-title">
                                                                        Observaciones de Consejo de Investigación
                                                                    </h5>
                                                                    <span class="pull-right clickable panel-collapsed">
                                                                        <i class="glyphicon glyphicon-chevron-down">
                                                                        </i>
                                                                ...
                                                                <div class="panel-body" style="display: none;">
                                                                    <li class="">
                                                                        ...
                                                                        <div class="panel2">
                                                                            <textarea readonly class="form-control" id="obs_prC" name="" rows="5" style="resize:none"></textarea>
                            ...
                            <div class="modal-footer">
                                ...
                                <button class="btn btn-warning" id="rechazar" name="rechazar" type="submit" type="button">
                                    Rechazar
                                </button>
                                <button class="btn btn-primary" id="aceptar" name="aceptar" type="submit" type="button">
                                    Aceptar
                                </button>
                                <!--<button class="btn btn-success" onclick="SolicitudEnviada2()" type="button">
                                    Enviar a O.S.P.I
                                </button>-->
                                <button class="btn btn-info" id="enviar_comite" name="enviar_comite" type="submit" type="button">
                                    Enviar a C.I
                                </button>
                            </div>
                        </form>
